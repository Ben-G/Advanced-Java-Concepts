...
public class Main {
	...
	public static void primitiveTypes() {
		/*
		 * Primitive Datentypen werden implizit immer als 'Value' an Methoden übergeben.
		 * Bei jeder Zuweisung einer Variable wird eine neue Kopie des Werts auf dem Stack angelegt.
		 */
		...
		// Die Bearbeitung einer Variable wirkt sich nicht auf die andere aus, da der Wert zuvor kopiert wurde
		i++;
	...
	public static void objectTypes() {
		/*
		 * Objekt-Variablen werden implizit immer per 'Reference' übergeben. Dies bedeutet, bei einer 
		 * Zuweisung oder einer Übergabe eines Objekts an eine Methode, wird keine Kopie des Objekts
		 * angelegt, sondern eine Referenz übergeben ('Zeiger').
		 * 
		 * Alle Variablen denen das Objekt zugewiesen wurde und alle Methoden, die die Variable übergeben
		 * bekommen haben, arbeiten auf der selben Objektinstanz.
		 */
		 ...
		 * Dies wirkt sich auf alle Objekte aus, die auf die Objektinstanz zeigen.
		 */
		...
		/*
		 * Möchte man ein Objekt, analog zu primitiven Datentypen, als Kopie übergeben,
		 * gibt es hierfür eine 'clone' Methode, diese wird im Interface 'Cloneable' deklariert.
		 * 
		 * Das eigene Objekt muss hierfür eine clone()-Methode implementieren.
		 * Wird clone() aufgerufen, wird eine Kopie des Objekts erstellt. Es wird also ein neues Objekt
		 * auf dem Heap angelegt. Dieses neue Objekt hat zunächst alle Eigenschaften des alten Objekts.
		 * Die beiden Instanzen können zukünftig unabhängig voneinander bearbeitet werden.
		 */
		...
		/*
		 * Über die Variable 'object2' arbeiten wir nun auf einem geklonten Objekt. Wir
		 * arbeiten also auf einer eigenen Instanz. Der Wert der in 'object1' referenziert Instanz wird
	...
	public static void cloneComplexWrong() {
		...
		/* Hier wird ein sogenanntes 'AutoBoxing' eingesetzt, um aus primitiven Datentypen Objekttypen
		zu erzeugen. Siehe package 'wrapperClasses'. */
